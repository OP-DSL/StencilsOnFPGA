...
void process_SLR0 (uint512_dt*  arg0, uint512_dt*  arg1, hls::stream <t_pkt> &in, hls::stream <t_pkt> &out,
	...
	process_grid( streamArray[10], streamArray[11], data_g);
	process_grid( streamArray[11], streamArray[12], data_g);

	process_grid( streamArray[12], streamArray[13], data_g);
	process_grid( streamArray[13], streamArray[14], data_g);
	process_grid( streamArray[14], streamArray[15], data_g);
	process_grid( streamArray[15], streamArray[16], data_g);

	process_grid( streamArray[16], streamArray[17], data_g);
	process_grid( streamArray[17], streamArray[18], data_g);
	process_grid( streamArray[18], streamArray[19], data_g);
	process_grid( streamArray[19], streamArray[20], data_g);

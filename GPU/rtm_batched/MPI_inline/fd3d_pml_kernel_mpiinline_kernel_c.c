  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    for ( int n_y=0; n_y<y_size; n_y++ ){
      for ( int n_x=0; n_x<x_size; n_x++ ){
        ...
        const ptr_float rho = { rho_p + n_x*1 + n_y * xdim4_fd3d_pml_kernel*1 + n_z * xdim4_fd3d_pml_kernel * ydim4_fd3d_pml_kernel*1, xdim4_fd3d_pml_kernel, ydim4_fd3d_pml_kernel};
        const ptr_float mu = { mu_p + n_x*1 + n_y * xdim5_fd3d_pml_kernel*1 + n_z * xdim5_fd3d_pml_kernel * ydim5_fd3d_pml_kernel*1, xdim5_fd3d_pml_kernel, ydim5_fd3d_pml_kernel};
        #ifdef OPS_SOA
        const ptrm_float yy = { yy_p + n_x*1 + n_y * xdim6_fd3d_pml_kernel*1 + n_z * xdim6_fd3d_pml_kernel * ydim6_fd3d_pml_kernel*1, xdim6_fd3d_pml_kernel, ydim6_fd3d_pml_kernel, zdim6_fd3d_pml_kernel};
        #else
        const ptrm_float yy = { yy_p + n_x*1 + n_y * xdim6_fd3d_pml_kernel*1 + n_z * xdim6_fd3d_pml_kernel * ydim6_fd3d_pml_kernel*1, xdim6_fd3d_pml_kernel, ydim6_fd3d_pml_kernel, 6};
        #endif
        #ifdef OPS_SOA
        ptrm_float dyy = { dyy_p + n_x*1 + n_y * xdim7_fd3d_pml_kernel*1 + n_z * xdim7_fd3d_pml_kernel * ydim7_fd3d_pml_kernel*1, xdim7_fd3d_pml_kernel, ydim7_fd3d_pml_kernel, zdim7_fd3d_pml_kernel};
        #else
        ptrm_float dyy = { dyy_p + n_x*1 + n_y * xdim7_fd3d_pml_kernel*1 + n_z * xdim7_fd3d_pml_kernel * ydim7_fd3d_pml_kernel*1, xdim7_fd3d_pml_kernel, ydim7_fd3d_pml_kernel, 6};
        #endif

...
//
__constant__ int dims_calc_ytemp2_kernel[8][4];
static int dims_calc_ytemp2_kernel_h[8][4] = {0};
...
#ifdef OPS_SOA
    const ACC<float> yy(
        6, dims_calc_ytemp2_kernel[5][0], dims_calc_ytemp2_kernel[5][1],
        dims_calc_ytemp2_kernel[5][2],
        yy_p + n_0 + n_1 * dims_calc_ytemp2_kernel[5][0] +
            n_2 * dims_calc_ytemp2_kernel[5][0] *
                dims_calc_ytemp2_kernel[5][1] +
            n_3 * dims_calc_ytemp2_kernel[5][0] *
                dims_calc_ytemp2_kernel[5][1] * dims_calc_ytemp2_kernel[5][2]);
#else
    const ACC<float> yy(6, dims_calc_ytemp2_kernel[5][0],
                        dims_calc_ytemp2_kernel[5][1],
                        dims_calc_ytemp2_kernel[5][2],
                        yy_p + 6 * (n_0 + n_1 * dims_calc_ytemp2_kernel[5][0] +
                                    n_2 * dims_calc_ytemp2_kernel[5][0] *
                                        dims_calc_ytemp2_kernel[5][1] +
                                    n_3 * dims_calc_ytemp2_kernel[5][0] *
                                        dims_calc_ytemp2_kernel[5][1] *
...
#endif
#ifdef OPS_SOA
    ACC<float> k(6, dims_calc_ytemp2_kernel[6][0],
                 dims_calc_ytemp2_kernel[6][1], dims_calc_ytemp2_kernel[6][2],
                 k_p + n_0 + n_1 * dims_calc_ytemp2_kernel[6][0] +
                     n_2 * dims_calc_ytemp2_kernel[6][0] *
                         dims_calc_ytemp2_kernel[6][1] +
                     n_3 * dims_calc_ytemp2_kernel[6][0] *
                         dims_calc_ytemp2_kernel[6][1] *
                         dims_calc_ytemp2_kernel[6][2]);
#else
    ACC<float> k(6, dims_calc_ytemp2_kernel[6][0],
                 dims_calc_ytemp2_kernel[6][1], dims_calc_ytemp2_kernel[6][2],
                 k_p + 6 * (n_0 + n_1 * dims_calc_ytemp2_kernel[6][0] +
                            n_2 * dims_calc_ytemp2_kernel[6][0] *
                                dims_calc_ytemp2_kernel[6][1] +
                            n_3 * dims_calc_ytemp2_kernel[6][0] *
                                dims_calc_ytemp2_kernel[6][1] *
...
#ifdef OPS_SOA
    ACC<float> ytemp(
        6, dims_calc_ytemp2_kernel[7][0], dims_calc_ytemp2_kernel[7][1],
        dims_calc_ytemp2_kernel[7][2],
        ytemp_p + n_0 + n_1 * dims_calc_ytemp2_kernel[7][0] +
            n_2 * dims_calc_ytemp2_kernel[7][0] *
                dims_calc_ytemp2_kernel[7][1] +
            n_3 * dims_calc_ytemp2_kernel[7][0] *
                dims_calc_ytemp2_kernel[7][1] * dims_calc_ytemp2_kernel[7][2]);
#else
    ACC<float> ytemp(6, dims_calc_ytemp2_kernel[7][0],
                     dims_calc_ytemp2_kernel[7][1],
                     dims_calc_ytemp2_kernel[7][2],
                     ytemp_p + 6 * (n_0 + n_1 * dims_calc_ytemp2_kernel[7][0] +
                                    n_2 * dims_calc_ytemp2_kernel[7][0] *
                                        dims_calc_ytemp2_kernel[7][1] +
                                    n_3 * dims_calc_ytemp2_kernel[7][0] *
                                        dims_calc_ytemp2_kernel[7][1] *
...
#endif
  if (args[5].dat->size[0] != dims_calc_ytemp2_kernel_h[5][0] ||
      args[5].dat->size[1] != dims_calc_ytemp2_kernel_h[5][1] ||
      args[5].dat->size[2] != dims_calc_ytemp2_kernel_h[5][2] ||
      args[5].dat->size[3] != dims_calc_ytemp2_kernel_h[5][3] ||
      args[6].dat->size[0] != dims_calc_ytemp2_kernel_h[6][0] ||
      args[6].dat->size[1] != dims_calc_ytemp2_kernel_h[6][1] ||
      args[6].dat->size[2] != dims_calc_ytemp2_kernel_h[6][2] ||
      args[6].dat->size[3] != dims_calc_ytemp2_kernel_h[6][3] ||
      args[7].dat->size[0] != dims_calc_ytemp2_kernel_h[7][0] ||
      args[7].dat->size[1] != dims_calc_ytemp2_kernel_h[7][1] ||
      args[7].dat->size[2] != dims_calc_ytemp2_kernel_h[7][2] ||
      args[7].dat->size[3] != dims_calc_ytemp2_kernel_h[7][3]) {
    dims_calc_ytemp2_kernel_h[5][0] = args[5].dat->size[0];
    dims_calc_ytemp2_kernel_h[5][1] = args[5].dat->size[1];
    dims_calc_ytemp2_kernel_h[5][2] = args[5].dat->size[2];
    dims_calc_ytemp2_kernel_h[5][3] = args[5].dat->size[3];
    dims_calc_ytemp2_kernel_h[6][0] = args[6].dat->size[0];
    dims_calc_ytemp2_kernel_h[6][1] = args[6].dat->size[1];
    dims_calc_ytemp2_kernel_h[6][2] = args[6].dat->size[2];
    dims_calc_ytemp2_kernel_h[6][3] = args[6].dat->size[3];
    dims_calc_ytemp2_kernel_h[7][0] = args[7].dat->size[0];
    dims_calc_ytemp2_kernel_h[7][1] = args[7].dat->size[1];
    dims_calc_ytemp2_kernel_h[7][2] = args[7].dat->size[2];
    dims_calc_ytemp2_kernel_h[7][3] = args[7].dat->size[3];
    cutilSafeCall(cudaMemcpyToSymbol(dims_calc_ytemp2_kernel,
                                     dims_calc_ytemp2_kernel_h,
                                     sizeof(dims_calc_ytemp2_kernel)));
  }

...
void buildOpenCLKernels_final_update_kernel(int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9) {
  ...
  if(!isbuilt_final_update_kernel) {
    ...
    printf("Compiling final_update_kernel %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim5_final_update_kernel=%d  -Dydim5_final_update_kernel=%d  -Dxdim6_final_update_kernel=%d  -Dydim6_final_update_kernel=%d  -Dxdim7_final_update_kernel=%d  -Dydim7_final_update_kernel=%d  -Dxdim8_final_update_kernel=%d  -Dydim8_final_update_kernel=%d  -Dxdim9_final_update_kernel=%d  -Dydim9_final_update_kernel=%d ", pPath, 32,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7,xdim8,ydim8,xdim9,ydim9);
        else
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_final_update_kernel", &ret);
    clSafeCall( ret );
...
void ops_par_loop_final_update_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg9) {
  ...
  buildOpenCLKernels_final_update_kernel(
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 0, sizeof(cl_int), (void*) arg0.data ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 1, sizeof(cl_int), (void*) arg1.data ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 2, sizeof(cl_int), (void*) arg2.data ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 3, sizeof(cl_float), (void*) arg4.data ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 4, sizeof(cl_mem), (void*) &arg5.data_d ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 5, sizeof(cl_mem), (void*) &arg6.data_d ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 6, sizeof(cl_mem), (void*) &arg7.data_d ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 7, sizeof(cl_mem), (void*) &arg8.data_d ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 8, sizeof(cl_mem), (void*) &arg9.data_d ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 9, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 10, sizeof(cl_int), (void*) &base6 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 11, sizeof(cl_int), (void*) &base7 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 12, sizeof(cl_int), (void*) &base8 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 13, sizeof(cl_int), (void*) &base9 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 14, sizeof(cl_int), (void*) &arg_idx[0] ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 15, sizeof(cl_int), (void*) &arg_idx[1] ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 16, sizeof(cl_int), (void*) &arg_idx[2] ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 17, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 18, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 19, sizeof(cl_int), (void*) &z_size ));

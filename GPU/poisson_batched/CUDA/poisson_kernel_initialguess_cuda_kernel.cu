...
int bounds_2_l, int bounds_2_u) {
  ...
  if (n_0 < bounds_0_u && n_1 < bounds_1_u && n_2 < bounds_2_u) {
    ACC<float> u(dims_poisson_kernel_initialguess[0][0], dims_poisson_kernel_initialguess[0][1], u_p + n_0 + n_1 * dims_poisson_kernel_initialguess[0][0] + n_2 * dims_poisson_kernel_initialguess[0][0] * dims_poisson_kernel_initialguess[0][1]);

...
void buildOpenCLKernels_poisson_kernel_error(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_poisson_kernel_error) {
    ...
    printf("Compiling poisson_kernel_error %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_poisson_kernel_error=%d  -Dydim0_poisson_kernel_error=%d  -Dxdim1_poisson_kernel_error=%d  -Dydim1_poisson_kernel_error=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
        else
          sprintf(buildOpts,"-cl-mad-enable -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_poisson_kernel_error=%d  -Dydim0_poisson_kernel_error=%d  -Dxdim1_poisson_kernel_error=%d  -Dydim1_poisson_kernel_error=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
      else {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[5] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_poisson_kernel_error", &ret);
    clSafeCall( ret );
...
void ops_par_loop_poisson_kernel_error(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[5], 3, nthread*sizeof(float), NULL));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[5], 4, sizeof(cl_int), (void*) &r_bytes2 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[5], 5, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[5], 6, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[5], 7, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[5], 8, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[5], 9, sizeof(cl_int), (void*) &z_size ));

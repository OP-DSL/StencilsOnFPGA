...
void buildOpenCLKernels_poisson_kernel_initialguess(int xdim0, int ydim0) {
  ...
  if(!isbuilt_poisson_kernel_initialguess) {
    ...
    printf("Compiling poisson_kernel_initialguess %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_poisson_kernel_initialguess=%d  -Dydim0_poisson_kernel_initialguess=%d ", pPath, 32,xdim0,ydim0);
        else
          sprintf(buildOpts,"-cl-mad-enable -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_poisson_kernel_initialguess=%d  -Dydim0_poisson_kernel_initialguess=%d ", pPath, 32,xdim0,ydim0);
      else {
...
void ops_par_loop_poisson_kernel_initialguess(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[2], 4, sizeof(cl_int), (void*) &z_size ));

...
void buildOpenCLKernels_poisson_kernel_update(int xdim0, int ydim0, int xdim1, int ydim1) {
  ...
  if(!isbuilt_poisson_kernel_update) {
    ...
    printf("Compiling poisson_kernel_update %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_poisson_kernel_update=%d  -Dydim0_poisson_kernel_update=%d  -Dxdim1_poisson_kernel_update=%d  -Dydim1_poisson_kernel_update=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
        else
          sprintf(buildOpts,"-cl-mad-enable -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_poisson_kernel_update=%d  -Dydim0_poisson_kernel_update=%d  -Dxdim1_poisson_kernel_update=%d  -Dydim1_poisson_kernel_update=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1);
      else {
    ...
    OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4] = clCreateKernel(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.program, "ops_poisson_kernel_update", &ret);
    clSafeCall( ret );
...
void ops_par_loop_poisson_kernel_update(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 2, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 3, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 4, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 5, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[4], 6, sizeof(cl_int), (void*) &z_size ));

...
void buildOpenCLKernels_poisson_kernel_populate(int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3) {
  ...
  if(!isbuilt_poisson_kernel_populate) {
    ...
    printf("Compiling poisson_kernel_populate %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim1_poisson_kernel_populate=%d  -Dydim1_poisson_kernel_populate=%d  -Dxdim2_poisson_kernel_populate=%d  -Dydim2_poisson_kernel_populate=%d  -Dxdim3_poisson_kernel_populate=%d  -Dydim3_poisson_kernel_populate=%d ", pPath, 32,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3);
        else
...
void ops_par_loop_poisson_kernel_populate(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  xdim1,ydim1,xdim2,ydim2,xdim3,ydim3);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 0, sizeof(cl_mem), (void*) &arg1.data_d ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 1, sizeof(cl_mem), (void*) &arg2.data_d ));
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 3, sizeof(cl_float), (void*) &dx ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 4, sizeof(cl_float), (void*) &dy ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 5, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 6, sizeof(cl_int), (void*) &base2 ));
    ...
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 8, sizeof(cl_int), (void*) &arg_idx[0] ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 9, sizeof(cl_int), (void*) &arg_idx[1] ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 10, sizeof(cl_int), (void*) &arg_idx[2] ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 11, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 12, sizeof(cl_int), (void*) &y_size ));
    clSafeCall( clSetKernelArg(OPS_instance::getOPSInstance()->opencl_instance->OPS_opencl_core.kernel[0], 13, sizeof(cl_int), (void*) &z_size ));

  ...
  for ( int n_z=0; n_z<z_size; n_z++ ){
    ...
    for ( int n_y=0; n_y<y_size; n_y++ ){
      ...
      for ( int n_x=0; n_x<x_size; n_x++ ){
        const ptr_float ptr0 = {  p_a0 + n_x*1*1 + n_y*xdim0_poisson_kernel_error*1*1 + n_z*xdim0_poisson_kernel_error*ydim0_poisson_kernel_error*1*1, xdim0_poisson_kernel_error, ydim0_poisson_kernel_error};
        const ptr_float ptr1 = {  p_a1 + n_x*1*1 + n_y*xdim1_poisson_kernel_error*1*1 + n_z*xdim1_poisson_kernel_error*ydim1_poisson_kernel_error*1*1, xdim1_poisson_kernel_error, ydim1_poisson_kernel_error};

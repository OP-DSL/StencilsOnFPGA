...
//
__constant__ int dims_poisson_kernel_populate [4][4];
static int dims_poisson_kernel_populate_h [4][4] = {0};
...
int bounds_2_l, int bounds_2_u, int bounds_3_l, int bounds_3_u) {
  ...
  if (n_0 < bounds_0_u && n_1 < bounds_1_u && n_2 < bounds_2_u && n_3 < bounds_3_u) {
    ACC<float> u(dims_poisson_kernel_populate[1][0], dims_poisson_kernel_populate[1][1], dims_poisson_kernel_populate[1][2], u_p + n_0 + n_1 * dims_poisson_kernel_populate[1][0] + n_2 * dims_poisson_kernel_populate[1][0] * dims_poisson_kernel_populate[1][1] + n_3 * dims_poisson_kernel_populate[1][0] * dims_poisson_kernel_populate[1][1] * dims_poisson_kernel_populate[1][2]);
    ACC<float> f(dims_poisson_kernel_populate[2][0], dims_poisson_kernel_populate[2][1], dims_poisson_kernel_populate[2][2], f_p + n_0 + n_1 * dims_poisson_kernel_populate[2][0] + n_2 * dims_poisson_kernel_populate[2][0] * dims_poisson_kernel_populate[2][1] + n_3 * dims_poisson_kernel_populate[2][0] * dims_poisson_kernel_populate[2][1] * dims_poisson_kernel_populate[2][2]);
    ACC<float> ref(dims_poisson_kernel_populate[3][0], dims_poisson_kernel_populate[3][1], dims_poisson_kernel_populate[3][2], ref_p + n_0 + n_1 * dims_poisson_kernel_populate[3][0] + n_2 * dims_poisson_kernel_populate[3][0] * dims_poisson_kernel_populate[3][1] + n_3 * dims_poisson_kernel_populate[3][0] * dims_poisson_kernel_populate[3][1] * dims_poisson_kernel_populate[3][2]);
...
void ops_par_loop_poisson_kernel_populate_execute(const char *name, ops_block block, int blockidx_start, int blockidx_end, int dim, int *range, int nargs, ops_arg* args) {
  ...
  #endif
  if (args[1].dat->size[0] != dims_poisson_kernel_populate_h[1][0] || args[1].dat->size[1] != dims_poisson_kernel_populate_h[1][1] || args[1].dat->size[2] != dims_poisson_kernel_populate_h[1][2] || args[1].dat->size[3] != dims_poisson_kernel_populate_h[1][3] || args[2].dat->size[0] != dims_poisson_kernel_populate_h[2][0] || args[2].dat->size[1] != dims_poisson_kernel_populate_h[2][1] || args[2].dat->size[2] != dims_poisson_kernel_populate_h[2][2] || args[2].dat->size[3] != dims_poisson_kernel_populate_h[2][3] || args[3].dat->size[0] != dims_poisson_kernel_populate_h[3][0] || args[3].dat->size[1] != dims_poisson_kernel_populate_h[3][1] || args[3].dat->size[2] != dims_poisson_kernel_populate_h[3][2] || args[3].dat->size[3] != dims_poisson_kernel_populate_h[3][3]) {
    ...
    dims_poisson_kernel_populate_h[1][3] = args[1].dat->size[3];
    ...
    dims_poisson_kernel_populate_h[2][3] = args[2].dat->size[3];

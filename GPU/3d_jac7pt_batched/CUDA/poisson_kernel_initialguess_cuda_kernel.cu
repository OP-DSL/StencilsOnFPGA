...
int bounds_2_l, int bounds_2_u, int bounds_3_l, int bounds_3_u) {
  ...
  if (n_0 < bounds_0_u && n_1 < bounds_1_u && n_2 < bounds_2_u && n_3 < bounds_3_u) {
    ACC<float> u(dims_poisson_kernel_initialguess[0][0], dims_poisson_kernel_initialguess[0][1], dims_poisson_kernel_initialguess[0][2], u_p + n_0 + n_1 * dims_poisson_kernel_initialguess[0][0] + n_2 * dims_poisson_kernel_initialguess[0][0] * dims_poisson_kernel_initialguess[0][1] + n_3 * dims_poisson_kernel_initialguess[0][0] * dims_poisson_kernel_initialguess[0][1] * dims_poisson_kernel_initialguess[0][2]);
...
void ops_par_loop_poisson_kernel_initialguess_execute(const char *name, ops_block block, int blockidx_start, int blockidx_end, int dim, int *range, int nargs, ops_arg* args) {
  ...
  #endif
  if (args[0].dat->size[0] != dims_poisson_kernel_initialguess_h[0][0] || args[0].dat->size[1] != dims_poisson_kernel_initialguess_h[0][1] || args[0].dat->size[2] != dims_poisson_kernel_initialguess_h[0][2] || args[0].dat->size[3] != dims_poisson_kernel_initialguess_h[0][3]) {
